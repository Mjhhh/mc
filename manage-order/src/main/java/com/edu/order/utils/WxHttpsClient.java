...
public class WxHttpsClient {
    ...
    public static JSONObject httpsRequestReturnJSONObject(String requestUrl, String requestMethod, String postData) throws Exception{
        JSONObject jsonObject = JSONObject.parseObject(WxHttpsClient.httpsRequestReturnString(requestUrl,requestMethod,postData));
    ...
    public static String httpsRequestReturnString(String requestUrl, String requestMethod, String postData) throws Exception{
        ...
        try{
            ...
            //判断是否需要提交数据
            if(StringUtils.equals(requestMethod,WxHttpsClient.METHOD_POST) && StringUtils.isNotBlank(postData)){
                //将参数转换为字节提交
